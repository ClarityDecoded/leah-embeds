...
img{{max-width:min(100%,900px);height:auto;}}
.hero-img,.break-img{{max-width:900px;margin-left:auto;margin-right:auto;}}
:where(.hero,.hero__art,.earthplate,figure) img{{margin-left:auto;margin-right:auto;}}
</style>
</head>
<body>
